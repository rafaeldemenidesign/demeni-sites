...
class D1PWAEditor {
    ...
    render() {
        ...
        const seoGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createTextInput({
                    ...
                    value: window.d1State.get(`${this.basePath}.seo.title`, ''),
                ...
                container.appendChild(C.createTextArea({
                    label: 'Descrição',
                    value: window.d1State.get(`${this.basePath}.seo.description`, ''),
                ...
                const ogImage = window.d1State.get(`${this.basePath}.seo.ogImage`, '');
                const heroBg = window.d1State.get('d2Adjustments.hero.bgImage', '');
                ...
                ogFileInput.addEventListener('change', async (e) => {
                    ...
                    try {
                        ...
                        window.d1State.set(`${this.basePath}.seo.ogImage`, dataUrl);
                ...
                if (ogImage) {
                    ...
                    removeOgBtn.addEventListener('click', () => {
                        window.d1State.set(`${this.basePath}.seo.ogImage`, null);
                        document.dispatchEvent(new CustomEvent('d2:section-selected', {
                            detail: { sectionId: 'pwa' }
                        }));
                    });
        ...
        const faviconGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createSelect({
                    label: 'Modo',
                    value: window.d1State.get(`${this.basePath}.favicon.mode`, 'auto'),
                    options: [
        ...
        const pwaGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createTextInput({
                    label: 'Nome do App',
                    value: window.d1State.get(`${this.basePath}.appName`, ''),
                ...
                container.appendChild(C.createColorPicker({
                    ...
                    value: window.d1State.get(`${this.basePath}.themeColor`, '#1a365d'),
    ...
    _renderModeControls(container) {
        const C = window.D1Controls;
        const mode = window.d1State.get(`${this.basePath}.favicon.mode`, 'auto');
        ...
        if (mode === 'upload') {
            ...
            const currentImage = window.d1State.get(`${this.basePath}.favicon.image`, '');
            ...
            fileInput.addEventListener('change', async (e) => {
                ...
                try {
                    ...
                    window.d1State.set(`${this.basePath}.favicon.image`, dataUrl);
                    this._renderModeControls(container);
                } catch (err) {
                    console.error('Erro ao processar favicon:', err);
                    const reader = new FileReader();
                    reader.onload = (ev) => {
                        window.d1State.set(`${this.basePath}.favicon.image`, ev.target.result);
                        this._renderModeControls(container);
                    };
            ...
            if (currentImage) {
                ...
                removeBtn.addEventListener('click', () => {
                    window.d1State.set(`${this.basePath}.favicon.image`, null);
                    this._renderModeControls(container);
                });
            ...
            container.appendChild(C.createColorPicker({
                label: 'Cor de fundo',
                value: window.d1State.get(`${this.basePath}.favicon.bgColor`, '#1a365d'),
                path: `${this.basePath}.favicon.bgColor`
            }));

            container.appendChild(C.createColorPicker({
                label: 'Cor do texto',
                value: window.d1State.get(`${this.basePath}.favicon.textColor`, '#ffffff'),
                path: `${this.basePath}.favicon.textColor`
            }));

            container.appendChild(C.createSelect({
                label: 'Formato',
                value: window.d1State.get(`${this.basePath}.favicon.shape`, 'circle'),
                options: [
    ...
    _renderFaviconPreview(canvas) {
        ...
        if (mode === 'upload') {
            const image = window.d1State.get(`${this.basePath}.favicon.image`, '');
            if (image) {
                const img = new Image();
                img.onload = () => {
                    const ctx = canvas.getContext('2d');
            ...
            const heroTitle = window.d1State.get('d2Adjustments.hero.title.text', 'Demeni Sites');
            const bgColor = window.d1State.get(`${this.basePath}.favicon.bgColor`, '#1a365d');
            const textColor = window.d1State.get(`${this.basePath}.favicon.textColor`, '#ffffff');
            const shape = window.d1State.get(`${this.basePath}.favicon.shape`, 'circle');
...
// Export
window.D1PWAEditor = D1PWAEditor;
