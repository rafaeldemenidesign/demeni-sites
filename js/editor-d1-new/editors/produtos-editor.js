    ...
    render() {
        ...
        const titleGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createToggle({
                    ...
                    value: window.d1State.get(`${this.basePath}.sectionTitle.enabled`, true),
                    path: `${this.basePath}.sectionTitle.enabled`
                }));
                container.appendChild(C.createTextInput({
                    label: 'Texto',
                    value: window.d1State.get(`${this.basePath}.sectionTitle.text`, 'Produtos Demeni'),
                    placeholder: 'Ex: Nossos Produtos',
                    path: `${this.basePath}.sectionTitle.text`
                }));
                container.appendChild(C.createSlider({
                    label: 'Tamanho',
                    value: window.d1State.get(`${this.basePath}.sectionTitle.size`, 36),
                ...
                container.appendChild(C.createColorPicker({
                    label: 'Cor',
                    value: window.d1State.get(`${this.basePath}.sectionTitle.color`, '#ffffff'),
                ...
                container.appendChild(C.createTextInput({
                    label: 'Texto',
                    value: window.d1State.get(`${this.basePath}.sectionSubtitle.text`, 'Confira nossos destaques'),
                ...
                container.appendChild(C.createColorPicker({
                    label: 'Cor',
                    value: window.d1State.get(`${this.basePath}.sectionSubtitle.color`, 'rgba(255,255,255,0.7)'),
                ...
                container.appendChild(C.createSlider({
                    ...
                    value: window.d1State.get(`${this.basePath}.sectionTitle.paddingBottom`, 24),
                    min: 0, max: 40, step: 2, unit: 'px',
        ...
        const gridGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createSlider({
                    ...
                    value: window.d1State.get(`${this.basePath}.gridColumns`, 2),
                ...
                container.appendChild(C.createSlider({
                    ...
                    value: window.d1State.get(`${this.basePath}.sectionPaddingH`, 32),
                ...
                container.appendChild(C.createSlider({
                    ...
                    value: window.d1State.get(`${this.basePath}.gridGap`, 16),
                ...
                container.appendChild(C.createSlider({
                    ...
                    value: window.d1State.get(`${this.basePath}.card.padding`, 6),
        ...
        const cardGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createColorPicker({
                    label: 'Cor de fundo',
                    value: window.d1State.get(`${this.basePath}.card.bgColor`, '#ffffff'),
                    path: `${this.basePath}.card.bgColor`
                }));

                container.appendChild(C.createSlider({
                    label: 'Arredondamento',
                    value: window.d1State.get(`${this.basePath}.card.borderRadius`, 20),
                    min: 0, max: 40, step: 2, unit: 'px',
                ...
                container.appendChild(C.createToggle({
                    label: 'Mostrar borda',
                    value: window.d1State.get(`${this.basePath}.card.borderEnabled`, false),
                    path: `${this.basePath}.card.borderEnabled`
                }));
                container.appendChild(C.createSlider({
                    label: 'Espessura',
                    value: window.d1State.get(`${this.basePath}.card.borderWidth`, 1),
                    min: 1, max: 5, step: 1, unit: 'px',
                    path: `${this.basePath}.card.borderWidth`
                }));
                container.appendChild(C.createColorPicker({
                    label: 'Cor da borda',
                    value: window.d1State.get(`${this.basePath}.card.borderColor`, '#e0e0e0'),
        ...
        const prodTitleGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createSlider({
                    ...
                    value: window.d1State.get(`${this.basePath}.title.size`, 15),
                    min: 10, max: 24, step: 1, unit: 'px',
                ...
                container.appendChild(C.createWeightSelector({
                    label: 'Peso da fonte',
                    value: window.d1State.get(`${this.basePath}.title.weight`, 500),
                    path: `${this.basePath}.title.weight`
                }));

                container.appendChild(C.createColorPicker({
                    label: 'Cor do texto',
                    value: window.d1State.get(`${this.basePath}.title.color`, '#333333'),
        ...
        const priceGroup = C.createGroupExpander(
            ...
            () => {
                ...
                const currentStyle = window.d1State.get(`${this.basePath}.preco.currencyStyle`, 'normal');
                ...
                styleSelector.querySelectorAll('.currency-style-btn').forEach(btn => {
                    btn.addEventListener('click', () => {
                        ...
                        window.d1State.set(`${this.basePath}.preco.currencyStyle`, style);
                ...
                container.appendChild(C.createSlider({
                    label: 'Tamanho da fonte',
                    value: window.d1State.get(`${this.basePath}.preco.size`, 16),
                ...
                container.appendChild(C.createWeightSelector({
                    label: 'Peso da fonte',
                    value: window.d1State.get(`${this.basePath}.preco.weight`, 800),
                    path: `${this.basePath}.preco.weight`
                }));

                container.appendChild(C.createColorPicker({
                    label: 'Cor do texto',
                    value: window.d1State.get(`${this.basePath}.preco.color`, '#333333'),
        ...
        const btnGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createTextInput({
                    ...
                    value: window.d1State.get(`${this.basePath}.btn.text`, 'Comprar'),
                ...
                container.appendChild(C.createSlider({
                    label: 'Tamanho da fonte',
                    value: window.d1State.get(`${this.basePath}.btn.size`, 13),
                ...
                container.appendChild(C.createWeightSelector({
                    label: 'Peso da fonte',
                    value: window.d1State.get(`${this.basePath}.btn.weight`, 600),
                    path: `${this.basePath}.btn.weight`
                }));

                container.appendChild(C.createColorPicker({
                    label: 'Cor do texto',
                    value: window.d1State.get(`${this.basePath}.btn.color`, '#ffffff'),
                ...
                const currentBgType = window.d1State.get(`${this.basePath}.btn.bgType`, 'solid');
                ...
                const solidColorEl = C.createColorPicker({
                    label: 'Cor de fundo',
                    value: window.d1State.get(`${this.basePath}.btn.bgColor`, '#25D366'),
                ...
                gradientWrapper.appendChild(
                    C.createGradientPresets({
                        value: window.d1State.get(`${this.basePath}.btn.bgGradient`, 'linear-gradient(135deg, #25D366 0%, #128C7E 100%)'),
                ...
                window.d1State.subscribe(({ path }) => {
                    if (path === `${this.basePath}.btn.bgType`) {
                        const newType = window.d1State.get(`${this.basePath}.btn.bgType`, 'solid');
                ...
                container.appendChild(C.createSlider({
                    label: 'Arredondamento',
                    value: window.d1State.get(`${this.basePath}.btn.borderRadius`, 20),
                    min: 0, max: 30, step: 2, unit: 'px',
                ...
                container.appendChild(C.createSlider({
                    ...
                    value: window.d1State.get(`${this.basePath}.btn.paddingH`, 14),
                ...
                container.appendChild(C.createSlider({
                    ...
                    value: window.d1State.get(`${this.basePath}.btn.paddingV`, 6),
        ...
        const productsGroup = C.createGroupExpander(
            ...
            () => {
                const container = document.createElement('div');
                const products = window.d1State.get('d2Products', []);
                            ...
                            () => {
                                ...
                                itemContainer.appendChild(
                                    C.createTextInput({
                                        ...
                                        placeholder: window.d1State.get(`${this.basePath}.btn.text`, 'Comprar'),
                                ...
                                itemContainer.appendChild(
                                    C.createColorPicker({
                                        label: 'Cor do botão',
                                        value: product.btnBgColor || window.d1State.get(`${this.basePath}.btn.bgColor`, '#25D366'),
                                ...
                                deleteBtn.addEventListener('click', () => {
                                    if (confirm(`Remover produto "${product.title}"?`)) {
                                        window.d1State.removeProduct(product.id);
                ...
                addBtn.onclick = () => {
                    ...
                    window.d1State.set('d2Products', products);
...
// Exporta globalmente
window.D1ProdutosEditor = D1ProdutosEditor;
