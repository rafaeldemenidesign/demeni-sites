        ...
        const logoGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(
                    C.createSlider({
                        label: 'Tamanho',
                        value: window.d1State.get(`${this.basePath}.logo.size`, 28),
                ...
                container.appendChild(
                    C.createSlider({
                        label: 'Opacidade',
                        value: window.d1State.get(`${this.basePath}.logo.opacity`, 0.8) * 100,
                ...
                container.appendChild(
                    C.createSelect({
                        label: 'Cor do logo',
                        value: window.d1State.get(`${this.basePath}.logo.color`, 'white'),
                        options: [
            ...
            () => {
                ...
                container.appendChild(
                    C.createTextInput({
                        ...
                        value: window.d1State.get(`${this.basePath}.title.text`, 'Invista no seu negócio!'),
                ...
                container.appendChild(
                    C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.title.size`, 24),
        ...
        const subtitleGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(
                    C.createSlider({
                        label: 'Tamanho da fonte',
                        value: window.d1State.get(`${this.basePath}.subtitle.size`, 14),
                ...
                container.appendChild(
                    C.createSlider({
                        label: 'Opacidade',
                        value: window.d1State.get(`${this.basePath}.subtitle.opacity`, 0.6) * 100,
                        min: 30, max: 100, step: 5, unit: '%',
        ...
        const infoGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(
                    C.createTextInput({
                        label: 'Email',
                        value: window.d1State.get(`${this.basePath}.info.email`, ''),
                ...
                container.appendChild(
                    C.createTextInput({
                        label: 'Telefone',
                        value: window.d1State.get(`${this.basePath}.info.phone`, ''),
                ...
                container.appendChild(
                    C.createTextInput({
                        label: 'CNPJ',
                        value: window.d1State.get(`${this.basePath}.info.cnpj`, ''),
                ...
                container.appendChild(
                    C.createSlider({
                        label: 'Tamanho da fonte',
                        value: window.d1State.get(`${this.basePath}.info.size`, 13),
                ...
                container.appendChild(
                    C.createSlider({
                        label: 'Opacidade',
                        value: window.d1State.get(`${this.basePath}.info.opacity`, 0.8) * 100,
                        min: 30, max: 100, step: 5, unit: '%',
            ...
            () => {
                ...
                container.appendChild(
                    C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.social.size`, 36),
                ...
                container.appendChild(
                    C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.social.gap`, 8),
                ...
                container.appendChild(
                    C.createTextInput({
                        label: 'Instagram',
                        value: window.d1State.get(`${this.basePath}.social.instagram`, ''),
                ...
                container.appendChild(
                    C.createTextInput({
                        label: 'Facebook',
                        value: window.d1State.get(`${this.basePath}.social.facebook`, ''),
                ...
                container.appendChild(
                    C.createTextInput({
                        label: 'WhatsApp',
                        value: window.d1State.get(`${this.basePath}.social.whatsapp`, ''),
...
// Exporta globalmente
window.D1FooterEditor = D1FooterEditor;
