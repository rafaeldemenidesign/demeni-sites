...
class D1CTAEditor {
    ...
    render() {
        ...
        const replicateHero = window.d1State.get(`${this.basePath}.replicateHero`, true);
            ...
            () => {
                ...
                const makeBtn = (mode, icon, label, isActive) => {
                    ...
                    btn.addEventListener('click', () => {
                        window.d1State.set(`${this.basePath}.replicateHero`, mode === 'hero');
        ...
        if (replicateHero) {
            ...
            const overrideGroup = C.createGroupExpander(
                ...
                () => {
                    ...
                    container.appendChild(C.createTextInput({
                        ...
                        value: window.d1State.get(`${this.basePath}.title.text`, ''),
                    ...
                    container.appendChild(C.createTextInput({
                        ...
                        value: window.d1State.get(`${this.basePath}.subtitle.text`, ''),
                    ...
                    container.appendChild(C.createTextInput({
                        ...
                        value: window.d1State.get(`${this.basePath}.btn.text`, ''),
                    ...
                    container.appendChild(C.createTextInput({
                        ...
                        value: window.d1State.get(`${this.basePath}.btn.link`, ''),
            ...
            const titleGroup = C.createGroupExpander(
                ...
                () => {
                    ...
                    container.appendChild(C.createSlider({
                        label: 'Tamanho',
                        value: window.d1State.get(`${this.basePath}.title.size`, 52),
                    ...
                    container.appendChild(C.createWeightSelector({
                        label: 'Peso',
                        value: window.d1State.get(`${this.basePath}.title.weight`, 400),
                        path: `${this.basePath}.title.weight`
                    }));

                    container.appendChild(C.createColorPicker({
                        label: 'Cor',
                        value: window.d1State.get(`${this.basePath}.title.color`, '#ffffff'),
                        path: `${this.basePath}.title.color`
                    }));

                    container.appendChild(C.createSlider({
                        label: 'Espaço abaixo',
                        value: window.d1State.get(`${this.basePath}.title.marginBottom`, 8),
            ...
            const subtitleGroup = C.createGroupExpander(
                ...
                () => {
                    ...
                    container.appendChild(C.createSlider({
                        label: 'Tamanho',
                        value: window.d1State.get(`${this.basePath}.subtitle.size`, 20),
                    ...
                    container.appendChild(C.createWeightSelector({
                        label: 'Peso',
                        value: window.d1State.get(`${this.basePath}.subtitle.weight`, 400),
                        path: `${this.basePath}.subtitle.weight`
                    }));

                    container.appendChild(C.createColorPicker({
                        label: 'Cor',
                        value: window.d1State.get(`${this.basePath}.subtitle.color`, '#ffffff'),
                        path: `${this.basePath}.subtitle.color`
                    }));

                    container.appendChild(C.createSlider({
                        label: 'Opacidade',
                        value: window.d1State.get(`${this.basePath}.subtitle.opacity`, 0.8) * 100,
                    ...
                    container.appendChild(C.createSlider({
                        label: 'Espaço abaixo',
                        value: window.d1State.get(`${this.basePath}.subtitle.marginBottom`, 20),
            ...
            const btnGroup = C.createGroupExpander(
                ...
                () => {
                    ...
                    container.appendChild(C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.btn.textStyle.size`, 16),
                    ...
                    container.appendChild(C.createWeightSelector({
                        label: 'Peso da fonte',
                        value: window.d1State.get(`${this.basePath}.btn.textStyle.weight`, 600),
                        path: `${this.basePath}.btn.textStyle.weight`
                    }));

                    container.appendChild(C.createColorPicker({
                        label: 'Cor do texto',
                        value: window.d1State.get(`${this.basePath}.btn.textStyle.color`, '#ffffff'),
                    ...
                    const solidColorEl = C.createColorPicker({
                        label: 'Cor de fundo',
                        value: window.d1State.get(`${this.basePath}.btn.bgColor`, '#5167E7'),
                    ...
                    gradientWrapper.appendChild(
                        C.createGradientPresets({
                            value: window.d1State.get(`${this.basePath}.btn.bgGradient`, 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'),
                    ...
                    container.appendChild(C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.btn.borderRadius`, 30),
                    ...
                    container.appendChild(C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.btn.paddingInner.vertical`, 12),
                    ...
                    container.appendChild(C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.btn.paddingInner.horizontal`, 40),
                    ...
                    container.appendChild(C.createToggle({
                        ...
                        value: window.d1State.get(`${this.basePath}.btn.hoverAnimation`, true),
...
// Exporta globalmente
window.D1CTAEditor = D1CTAEditor;
