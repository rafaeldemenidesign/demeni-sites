    ...
    render() {
        ...
        const titleGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createTextInput({
                    label: 'Texto',
                    value: window.d1State.get(`${this.basePath}.sectionTitle.text`, 'O que estão dizendo?'),
                ...
                container.appendChild(C.createTextInput({
                    label: 'Texto',
                    value: window.d1State.get(`${this.basePath}.sectionSubtitle.text`, 'Depoimentos de nossos clientes'),
        ...
        const textGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createSlider({
                    label: 'Tamanho',
                    value: window.d1State.get(`${this.basePath}.name.size`, 16),
                    min: 12, max: 24, step: 1, unit: 'px',
                    path: `${this.basePath}.name.size`
                }));
                container.appendChild(C.createWeightSelector({
                    label: 'Peso',
                    value: window.d1State.get(`${this.basePath}.name.weight`, 500),
                    path: `${this.basePath}.name.weight`
                }));
                container.appendChild(C.createColorPicker({
                    label: 'Cor',
                    value: window.d1State.get(`${this.basePath}.name.color`, '#1a365d'),
                ...
                container.appendChild(C.createSlider({
                    label: 'Tamanho',
                    value: window.d1State.get(`${this.basePath}.text.size`, 13),
                    min: 10, max: 18, step: 1, unit: 'px',
                    path: `${this.basePath}.text.size`
                }));
                container.appendChild(C.createWeightSelector({
                    label: 'Peso',
                    value: window.d1State.get(`${this.basePath}.text.weight`, 400),
                    path: `${this.basePath}.text.weight`
                }));
                container.appendChild(C.createColorPicker({
                    label: 'Cor',
                    value: window.d1State.get(`${this.basePath}.text.color`, '#666666'),
        ...
        const avatarGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createSlider({
                    label: 'Tamanho',
                    value: window.d1State.get(`${this.basePath}.avatar.size`, 60),
                ...
                container.appendChild(C.createSlider({
                    ...
                    value: window.d1State.get(`${this.basePath}.avatar.radius`, 8),
        ...
        const cardGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(C.createSlider({
                    label: 'Arredondamento',
                    value: window.d1State.get(`${this.basePath}.card.borderRadius`, 12),
                    min: 0, max: 30, step: 2, unit: 'px',
                ...
                container.appendChild(C.createToggle({
                    label: 'Efeito Glass',
                    value: window.d1State.get(`${this.basePath}.card.glass`, false),
                    path: `${this.basePath}.card.glass`
                }));

                if (window.d1State.get(`${this.basePath}.card.glass`, false)) {
                    container.appendChild(C.createSlider({
                        label: 'Intensidade blur',
                        value: window.d1State.get(`${this.basePath}.card.glassBlur`, 10),
                ...
                if (window.d1State.get(`${this.basePath}.card.borderEnabled`, false)) {
                    container.appendChild(C.createSlider({
                        label: 'Espessura',
                ...
                container.appendChild(C.createToggle({
                    ...
                    value: window.d1State.get(`${this.basePath}.cardAnimation`, true),
        ...
        const ctaGroup = C.createGroupExpander(
            ...
            () => {
                ...
                const toggleEl = C.createToggle({
                    ...
                    value: window.d1State.get(`${this.basePath}.bottomCta.enabled`, false),
                ...
                if (window.d1State.get(`${this.basePath}.bottomCta.enabled`, false)) {
                    container.appendChild(C.createTextInput({
                        label: 'Texto',
                        value: window.d1State.get(`${this.basePath}.bottomCta.text`, 'Faça parte dos nossos clientes satisfeitos!'),
                        placeholder: 'Texto de chamada...',
                        path: `${this.basePath}.bottomCta.text`
                    }));
                    container.appendChild(C.createSlider({
                        label: 'Tamanho',
                        value: window.d1State.get(`${this.basePath}.bottomCta.size`, 16),
                        min: 10, max: 30, step: 1, unit: 'px',
                        path: `${this.basePath}.bottomCta.size`
                    }));
                    container.appendChild(C.createWeightSelector({
                        label: 'Peso',
                        value: window.d1State.get(`${this.basePath}.bottomCta.weight`, 400),
                        path: `${this.basePath}.bottomCta.weight`
                    }));
                    container.appendChild(C.createColorPicker({
                        label: 'Cor',
                        value: window.d1State.get(`${this.basePath}.bottomCta.color`, '#333333'),
                        path: `${this.basePath}.bottomCta.color`
                    }));
                    container.appendChild(C.createSlider({
                        label: 'Espaço acima',
                        value: window.d1State.get(`${this.basePath}.bottomCta.paddingTop`, 20),
                        min: 0, max: 60, step: 2, unit: 'px',
                        path: `${this.basePath}.bottomCta.paddingTop`
                    }));
                    container.appendChild(C.createSlider({
                        label: 'Espaço abaixo',
                        value: window.d1State.get(`${this.basePath}.bottomCta.paddingBottom`, 20),
                        min: 0, max: 60, step: 2, unit: 'px',
        ...
        const feedbacksGroup = C.createGroupExpander(
            ...
            () => {
                const container = document.createElement('div');
                const feedbacks = window.d1State.get('d2Feedbacks', []);
                            ...
                            () => {
                                ...
                                deleteBtn.addEventListener('click', () => {
                                    if (confirm(`Remover depoimento de "${feedback.name}"?`)) {
                                        window.d1State.removeFeedback(feedback.id);
                                        document.dispatchEvent(new CustomEvent('d2:section-selected', {
                                            detail: { sectionId: 'feedbacks' }
                                        }));
                                    }
                ...
                addBtn.onclick = () => {
                    ...
                    window.d1State.set('d2Feedbacks', feedbacks);
                    document.dispatchEvent(new CustomEvent('d2:section-selected', {
                        detail: { sectionId: 'feedbacks' }
                    }));
...
// Exporta globalmente
window.D1FeedbacksEditor = D1FeedbacksEditor;
