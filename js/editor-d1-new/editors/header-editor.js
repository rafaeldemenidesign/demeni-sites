            ...
            () => {
                ...
                container.appendChild(
                    C.createImagePicker({
                        ...
                        value: window.d1State.get('profile.logo'),
                        path: 'profile.logo',
                        aspect: 'auto'
                    })
                );
                ...
                container.appendChild(
                    C.createSelect({
                        ...
                        value: window.d1State.get(`${this.basePath}.logoPosition`, 'left'),
                        options: [
                ...
                container.appendChild(
                    C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.logo.posX`, 0),
                ...
                container.appendChild(
                    C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.logo.posY`, 0),
            ...
            () => {
                ...
                container.appendChild(
                    C.createSlider({
                        ...
                        value: window.d1State.get(`${this.basePath}.height`, 80),
                ...
                const currentBgType = window.d1State.get(`${this.basePath}.bgType`, 'solid');
                ...
                const solidColorEl = C.createColorPicker({
                    label: 'Cor de fundo',
                    value: window.d1State.get(`${this.basePath}.bgColor`, '#2d2d2d'),
                ...
                gradientWrapper.appendChild(
                    C.createGradientPresets({
                        value: window.d1State.get(`${this.basePath}.bgGradient`, 'linear-gradient(135deg, #5167E7 0%, #A3B1FE 33%, #495FDB 66%, #2D3A81 100%)'),
                ...
                gradientWrapper.appendChild(
                    C.createSelect({
                        label: 'Orientação',
                        value: window.d1State.get(`${this.basePath}.bgGradientOrientation`, 'horizontal'),
                        options: [
                ...
                gradientWrapper.appendChild(
                    C.createToggle({
                        ...
                        value: window.d1State.get(`${this.basePath}.bgGradientInvert`, false),
                ...
                window.d1State.subscribe(({ path }) => {
                    if (path === `${this.basePath}.bgType`) {
                        const newType = window.d1State.get(`${this.basePath}.bgType`, 'solid');
                ...
                container.appendChild(
                    C.createColorPicker({
                        ...
                        value: window.d1State.get(`${this.basePath}.textColor`, '#ffffff'),
        ...
        const brandGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(
                    C.createTextInput({
                        label: 'Nome da marca',
                        value: window.d1State.get('profile.name', ''),
                ...
                container.appendChild(
                    C.createTextInput({
                        ...
                        value: window.d1State.get('profile.role', ''),
        ...
        const sidebarGroup = C.createGroupExpander(
            ...
            () => {
                ...
                container.appendChild(
                    C.createColorPicker({
                        label: 'Cor de fundo',
                        value: window.d1State.get(`${this.basePath}.sidebar.bgColor`, '#1a1a1a'),
                ...
                container.appendChild(
                    C.createColorPicker({
                        label: 'Cor do texto',
                        value: window.d1State.get(`${this.basePath}.sidebar.textColor`, '#ffffff'),
                ...
                container.appendChild(
                    C.createColorPicker({
                        ...
                        value: window.d1State.get(`${this.basePath}.sidebar.accentColor`, '#e67e22'),
...
// Exporta globalmente
window.D1HeaderEditor = D1HeaderEditor;
