    ...
    window.D1Controls = {
        ...
        `;
            ...
            input.addEventListener('input', (e) => {
                if (path && window.d1State) {
                    window.d1State.set(path, e.target.value);
                }
            });
        ...
        `;
            ...
            input.addEventListener('input', (e) => {
                ...
                if (path && window.d1State) {
                    window.d1State.set(path, parseFloat(e.target.value));
                }
            });
        ...
        `;
            ...
            select.addEventListener('change', (e) => {
                if (path && window.d1State) {
                    ...
                    window.d1State.set(path, isNaN(val) ? val : Number(val));
                }
            });
        ...
        loadGoogleFont(fontName) {
            ...
            console.log(`[D1Controls] Google Font carregada: ${fontName}`);
        },
        ...
        createImagePicker(options) {
            ...
            const aspectStyle = compact ? 'aspect-ratio: 1/1; max-height: 80px;' : `aspect-ratio: ${aspect}; max-height: 120px;`;
        ...
        `;
            ...
            fileInput.addEventListener('change', async (e) => {
                ...
                `;
                    ...
                    if (path && window.d1State) {
                        window.d1State.set(path, webpDataUrl);
                    }
                    ...
                    reader.onload = (event) => {
                        ...
                        previewBox.classList.add('has-image');
                        if (path && window.d1State) {
                            window.d1State.set(path, imageUrl);
                        }
                    };
        ...
        `;
            ...
            inputs.forEach(input => {
                input.addEventListener('input', (e) => {
                    ...
                    if (path && window.d1State) {
                        window.d1State.set(`${path}.${side}`, newValue);
                    }
                });
            });
        ...
        `;
            ...
            checkbox.addEventListener('change', (e) => {
                ...
                if (path && window.d1State) {
                    window.d1State.set(path, isChecked);
                }
            });
        ...
        createBgSection(options) {
            ...
            return C.createGroupExpander(
                ...
                () => {
                    ...
                    const bgMode = window.d1State.get(`${bp}.bgMode`, d.bgMode);
                ...
                `;
                    ...
                    modeDiv.querySelectorAll('.mode-btn').forEach(btn => {
                        btn.addEventListener('click', () => {
                            window.d1State.set(`${bp}.bgMode`, btn.dataset.mode);
                    ...
                    if (bgMode === 'color') {
                        ...
                        container.appendChild(C.createColorPicker({
                            label: 'Cor principal',
                            value: window.d1State.get(`${bp}.bgColor`, d.bgColor),
                            path: `${bp}.bgColor`
                        }));

                        container.appendChild(C.createToggle({
                            label: 'Ativar degradê',
                            value: window.d1State.get(`${bp}.bgGradient`, d.bgGradient),
                            path: `${bp}.bgGradient`
                        }));

                        container.appendChild(C.createColorPicker({
                            label: 'Cor 2 (degradê)',
                            value: window.d1State.get(`${bp}.bgColor2`, d.bgColor2),
                            path: `${bp}.bgColor2`
                        }));
                        container.appendChild(C.createToggle({
                            label: 'Inverter direção',
                            value: window.d1State.get(`${bp}.bgGradientInvert`, d.bgGradientInvert),
                        ...
                        container.appendChild(C.createImagePicker({
                            ...
                            value: window.d1State.get(`${bp}.bgImage`, d.bgImage),
                            path: `${bp}.bgImage`,
                            aspect: '16/9'
                        }));
                        ...
                        container.appendChild(C.createSlider({
                            label: 'Desfoque',
                            value: window.d1State.get(`${bp}.bgImageBlur`, d.bgImageBlur),
                            min: 0, max: 20, step: 1, unit: 'px',
                            path: `${bp}.bgImageBlur`
                        }));
                        container.appendChild(C.createSlider({
                            label: 'Zoom',
                            value: window.d1State.get(`${bp}.bgImageZoom`, d.bgImageZoom),
                            min: 100, max: 300, step: 5, unit: '%',
                            path: `${bp}.bgImageZoom`
                        }));
                        container.appendChild(C.createSlider({
                            label: 'Posição horizontal',
                            value: window.d1State.get(`${bp}.bgImagePosX`, d.bgImagePosX),
                            min: 0, max: 100, step: 5, unit: '%',
                            path: `${bp}.bgImagePosX`
                        }));
                        container.appendChild(C.createSlider({
                            label: 'Posição vertical',
                            value: window.d1State.get(`${bp}.bgImagePosY`, d.bgImagePosY),
                            min: 0, max: 100, step: 5, unit: '%',
                            path: `${bp}.bgImagePosY`
                        }));
                        ...
                        container.appendChild(C.createToggle({
                            ...
                            value: window.d1State.get(`${bp}.bgOverlay`, d.bgOverlay),
                            path: `${bp}.bgOverlay`
                        }));
                        ...
                        if (window.d1State.get(`${bp}.bgOverlay`, d.bgOverlay)) {
                            container.appendChild(C.createSelect({
                                label: 'Tipo',
                                value: window.d1State.get(`${bp}.bgOverlayType`, d.bgOverlayType),
                                options: [
                            ...
                            container.appendChild(C.createColorPicker({
                                ...
                                value: window.d1State.get(`${bp}.bgOverlayColor`, d.bgOverlayColor),
                                path: `${bp}.bgOverlayColor`
                            }));
                            const overlayType = window.d1State.get(`${bp}.bgOverlayType`, d.bgOverlayType);
                            if (overlayType === 'gradient') {
                                container.appendChild(C.createColorPicker({
                                    label: 'Cor 2',
                                    value: window.d1State.get(`${bp}.bgOverlayColor2`, d.bgOverlayColor2),
                                    path: `${bp}.bgOverlayColor2`
                                }));
                            }
                            container.appendChild(C.createSlider({
                                label: 'Opacidade',
                                value: window.d1State.get(`${bp}.bgOverlayOpacity`, d.bgOverlayOpacity),
                                min: 0, max: 100, step: 5, unit: '%',
                            ...
                            if (overlayType !== 'solid') {
                                container.appendChild(C.createToggle({
                                    label: 'Inverter',
                                    value: window.d1State.get(`${bp}.bgOverlayInvert`, d.bgOverlayInvert),
                                    path: `${bp}.bgOverlayInvert`
                                }));
                                container.appendChild(C.createSlider({
                                    label: 'Posição',
                                    value: window.d1State.get(`${bp}.bgOverlayPosition`, d.bgOverlayPosition),
                                    min: 0, max: 100, step: 5, unit: '%',
                                    path: `${bp}.bgOverlayPosition`
                                }));
                                container.appendChild(C.createSlider({
                                    label: 'Suavidade',
                                    value: window.d1State.get(`${bp}.bgOverlaySpread`, d.bgOverlaySpread),
                    ...
                    container.appendChild(C.createSlider({
                        ...
                        value: window.d1State.get(`${bp}.paddingTop`, d.paddingTop),
                        min: 0, max: 80, step: 5, unit: 'px',
                        path: `${bp}.paddingTop`
                    }));
                    container.appendChild(C.createSlider({
                        label: 'Padding inferior',
                        value: window.d1State.get(`${bp}.paddingBottom`, d.paddingBottom),
                        min: 0, max: 80, step: 5, unit: 'px',
            ...
            return C.createGroupExpander(
                ...
                () => {
                    ...
                    container.appendChild(C.createToggle({
                        ...
                        value: window.d1State.get(`${tlPath}.enabled`, false),
                        path: `${tlPath}.enabled`
                    }));

                    container.appendChild(C.createSlider({
                        label: 'Altura',
                        value: window.d1State.get(`${tlPath}.height`, 3),
                    ...
                    container.appendChild(C.createSelect({
                        label: 'Tipo',
                        value: window.d1State.get(`${tlPath}.bgType`, 'gradient'),
                        options: [
                    ...
                    container.appendChild(C.createColorPicker({
                        label: 'Cor',
                        value: window.d1State.get(`${tlPath}.bgColor`, '#5167E7'),
                        path: `${tlPath}.bgColor`
                    }));

                    // Presets de degradê (quando tipo = gradient)
                    if (window.d1State.get(`${tlPath}.bgType`, 'gradient') === 'gradient') {
                        ...
                        container.appendChild(C.createGradientPresets({
                            value: window.d1State.get(`${tlPath}.bgGradient`, 'linear-gradient(135deg, #5167E7 0%, #A3B1FE 33%, #495FDB 66%, #2D3A81 100%)'),
        ...
        createTextGradientControls(options) {
            ...
            container.appendChild(C.createToggle({
                ...
                value: window.d1State.get(`${tgPath}.enabled`, false),
                path: `${tgPath}.enabled`
            }));

            // Presets de degradê (quando ativado)
            if (window.d1State.get(`${tgPath}.enabled`, false)) {
                const label = document.createElement('div');
                label.style.cssText = 'font-size: 11px; opacity: 0.6; margin-top: 8px;';
                label.textContent = 'Escolha o degradê:';
                container.appendChild(label);
                container.appendChild(C.createGradientPresets({
                    value: window.d1State.get(`${tgPath}.gradient`, 'linear-gradient(135deg, #5167E7 0%, #A3B1FE 50%, #2D3A81 100%)'),
