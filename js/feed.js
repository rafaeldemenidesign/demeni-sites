...
(function () {
    ...
    const MOCK_POSTS = [
        {
            ...
            text: 'Bem-vindo ├á P├ígina Inicial! Aqui voc├¬ vai encontrar todas as atualiza├º├Áes, novidades e dicas da plataforma Demeni Sites. Fique ligado para n├úo perder nenhuma novidade importante sobre novas funcionalidades e tutoriais.',
            image: 'assets/feed/post-1.webp',
        ...
        },
        {
            ...
            text: 'Nova aula dispon├¡vel! Aprenda a criar sites profissionais com o editor D2. Neste tutorial completo, vamos cobrir todos os aspectos do design moderno, desde a escolha de cores at├® a otimiza├º├úo para dispositivos m├│veis. Acesse a se├º├úo Aulas para come├ºar.',
            image: 'assets/feed/post-2.webp',
        ...
        },
        {
            ...
            text: 'Parab├®ns a todos que alcan├ºaram o N├¡vel 2! Continuem criando sites incr├¡veis e ganhando XP. Lembrem-se: quanto mais sites voc├¬s criam, mais experi├¬ncia ganham e mais funcionalidades desbloqueiam. O pr├│ximo marco ├® o N├¡vel 3 ÔÇö Silver!',
            image: 'assets/feed/post-3.webp',
            title: 'Conquistas & N├¡veis',
            likes: 42,
            isLiked: false,
            isFavorited: false
        }
    ...
    async function loadPosts() {
        ...
        if (typeof SupabaseClient !== 'undefined' && SupabaseClient?.isConfigured()) {
            try {
                ...
                console.log('­ƒô░ Feed: Supabase unavailable, using mock data', e);
            }
        }
    ...
    async function syncInteractionToSupabase(postId, liked, favorited) {
        ...
        try {
            ...
            console.log('­ƒô░ Feed: interaction sync failed', e);
        }
    }
        ...
        if (filtered.length === 0) {
            container.innerHTML = `
                <div class="feed-empty">
                    ...
                    <p>Favorite posts para encontr├í-los aqui rapidamente</p>
                </div>`;
            return;
        }
